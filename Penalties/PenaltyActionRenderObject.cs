public class PenaltyActionRenderObject : RenderObject
{
    ...
    public SeasonRenderObject TargetSeason { get; set; }
    public bool IsHaveOnlyOneSeasonAreaUi { get; set; }
    public string SeasonsAreaStringUi { get; set; }
    public IList<SeasonRenderObject> SeasonsArea { get; set; }
    public DriverSessionRenderObject TargetDriverSession { get; set; }
    public PenaltyItemRenderObject PenaltyItem { get; set; }
